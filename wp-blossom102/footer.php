	...
	<div id="footer">
		<div class="limit clearfix">
			...
			<?php } ?>
			&copy;  <?php echo date('Y'); ?> <?php bloginfo('name'); ?>. <?php _e("All rights reserved.", "solostream"); ?> <a href="http://www.solostream.com" rel="nofollow"><?php _e("Theme by Solostream", "solostream"); ?></a>.
		</div>
	</div> <!-- End #footer div -->
