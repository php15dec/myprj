...
$categories_list = get_categories('hide_empty=1&orderby=name');
$getcat = array();
...
$options = array();
	...
	$options[] = array(
			...
			"pre" => "",
			"std" => "96",
			"options" => array("24", "36", "48", "60", "72", "84", "96", "108", "120", "132", "144"),
...
// Home Page Posts Arranged by Category
	...
	$options[] = array(
			...
			"id" => $shortname."_cat_box_10_title",
			"type" => "text",
			"pre" => "",
			"std" => "",
...
// Featured Posts
	...
	$options[] = array(
			...
			"pre" => "",
			"std" => "",
			"help" => __("Optional: provide a title for your featured content. Example: 'Featured Content'", "solostream"));
...
// Top Nav Style Settings
	...
	$options[] = array(
			...
			"std" => "no",
			"options" => array("no", "yes"),
			"help" => __("Select yes to show the top navigation bar.", "solostream"));
...
// Secondary Nav Style Settings

	$options[] = array(
			"name" => __("Secondary Navigation Style Settings", "solostream"),
			"id" => $shortname."_catnav_style_settings",
			"std" => "",
			"type" => "header");

	$options[] = array(
			"name" => __("Display Secondary Navigation", "solostream"),
			"id" => $shortname."_show_catnav",
			"type" => "select",
			"pre" => "",
			"std" => "yes",
			"options" => array("no", "yes"),
			"help" => __("Select no to hide the Secondary navigation bar.", "solostream"));

	$options[] = array(
			"name" => __("Secondary  Navigation Font Family", "solostream"),
	...
	$options[] = array(
			"name" => __("Secondary Navigation Font Size", "solostream"),
	...
	$options[] = array(
			"name" => __("Secondary Navigation Font Weight", "solostream"),
	...
	$options[] = array(
			"name" => __("Secondary Navigation Background Color", "solostream"),
	...
	$options[] = array(
			"name" => __("Secondary Navigation Link Color", "solostream"),
	...
	$options[] = array(
			"name" => __("Secondary Navigation Link Hover Color", "solostream"),
	...
	$options[] = array(
			"name" => __("Secondary Navigation Link Hover Background Color", "solostream"),
...
<div id="settings-wrap" class="clearfix">
	...
	<div id="welcome" class="content">
		...
		<?php
			if ( isset($_REQUEST['saved']) && $_REQUEST['saved'] ) echo '<div id="message"><strong>Your Settings Have Been Saved.</strong></div>';
			if ( isset($_REQUEST['reset']) && $_REQUEST['reset'] ) echo '<div id="message"><strong>Your Settings Have Been Reset.</strong></div>';
		?>
