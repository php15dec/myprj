...
if ($vimid) { $vimurl = 'http://player.vimeo.com/video/' . $vimid . '?api=1&amp;player_id=wide_player_' . $count . '&amp;byline=0&amp;portrait=0&amp;title=0'; }
				...
				<div class="slide-container clearfix">
					...
					<?php if ( $embed ) { ?>
						<div class="feature-video">
							<div class="video">
								<?php if ($yturl != '') { ?>
									<iframe id="wide_player_<?php echo $count; ?>" src="<?php echo $yturl; ?>&amp;wmode=transparent" width="1280" height="720" frameborder="0"></iframe>
								<?php } elseif ($vimurl != '') { ?>
									<iframe id="wide_player_<?php echo $count; ?>" src="<?php echo $vimurl; ?>&amp;wmode=transparent" width="1280" height="720" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>
								<?php } else { ?>
									<?php
										if (preg_match_all('/(<iframe)/', $embed, $matches)) {
											echo preg_replace('/(<iframe)/', '<iframe id="wide_player_' . $count . '" ', $embed);
										} else {
											echo $embed;
										}
									?>
