...
// Site Title Logo Styles
	...
	if ( $header_bg_color )
		$output .= '#header {background-color:'.$header_bg_color.';}' . "\n";
...
// Button Colors
	...
	if ( $button_bg )
		$output .= '#commentform input[type="submit"],#commentform input[type="button"],.archive-tabs a,.archive-tabs a:link,.archive-tabs a:visited,.readmore a.more-link, .readmore a.more-link:link,.readmore a.more-link:visited,.email-form input[type="submit"],.email-form input[type="button"],#searchform input[type="submit"],#searchform input[type="button"],.wpcf7 input[type="submit"],.wpcf7 input[type="button"] {border-color:'.$button_bg.';background-color:'.$button_bg.';}' . "\n";
	if ( $button_font )
		$output .= '#commentform input[type="submit"],#commentform input[type="button"],.archive-tabs a,.archive-tabs a:link,.archive-tabs a:visited,.readmore a.more-link, .readmore a.more-link:link,.readmore a.more-link:visited,.email-form input[type="submit"],.email-form input[type="button"],#searchform input[type="submit"],#searchform input[type="button"],.wpcf7 input[type="submit"],.wpcf7 input[type="button"] {color:'.$button_font.' !important;}' . "\n";
	if ( $button_hover_bg )
		$output .= '#commentform input[type="submit"]:hover,#commentform input[type="button"]:hover,.archive-tabs a:hover,.archive-tabs a:active,.archive-tabs .ui-tabs-selected a,.readmore a.more-link:hover,.readmore a.more-link:active,.email-form input[type="submit"]:hover,.email-form input[type="button"]:hover,#searchform input[type="submit"]:hover,#searchform input[type="button"]:hover,.wpcf7 input[type="submit"]:hover,.wpcf7 input[type="button"]:hover {border-color:'.$button_hover_bg.';background-color:'.$button_hover_bg.';}' . "\n";
	if ( $button_hover_font )
		$output .= '#commentform input[type="submit"]:hover,#commentform input[type="button"]:hover,.archive-tabs a:hover,.archive-tabs a:active,.archive-tabs .ui-tabs-selected a,.readmore a.more-link:hover,.readmore a.more-link:active,.email-form input[type="submit"]:hover,.email-form input[type="button"]:hover,#searchform input[type="submit"]:hover,#searchform input[type="button"]:hover,.wpcf7 input[type="submit"]:hover,.wpcf7 input[type="button"]:hover {color:'.$button_hover_font.' !important;}' . "\n";
